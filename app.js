...
const FALLBACK_DATA = {
  ...
  price: { symbol: 'XAUUSD', last: 2400.00, prev_close: 2400.00, change_pct: 0, change_abs: 0, spread: 0.30, day_high: 2400.00, day_low: 2400.00 },
...
function renderHeader() {
  ...
  statusEl.className = 'hdr-status ' + (STATE.liveStatus === 'LIVE' ? 'ok' : 'degraded');
